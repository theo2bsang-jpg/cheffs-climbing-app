...
/** Three-step wizard to create a conti loop on a spray wall. */
export default function ContiBoucleCreate() {
  ...
  // Fetch wall context for photo/name
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-yellow-50 p-4">
      <div className="max-w-4xl mx-auto pt-6 pb-20">
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  placeholder="Ex: Circuit endurance 20 mouvements"
                />
              </div>
              <div>
        ...
        {step === 2 && (
          <Card>
            <CardHeader>
              <CardTitle>Sélection des prises (dans l'ordre)</CardTitle>
            </CardHeader>
            <CardContent>
              <HoldSelector
            ...
            <CardContent>
              ...
              <div className="flex gap-3 mt-6">
                ...
                >
                  ...
                  {createMutation.isLoading ? "Création..." : "Créer la boucle"}
                </Button>
              </div>
            </CardContent>
          </Card>
        ...
        <AlertDialog open={showCancelDialog} onOpenChange={setShowCancelDialog}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Êtes-vous sûr de vouloir abandonner la création de la boucle ? Toutes les modifications seront perdues.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
